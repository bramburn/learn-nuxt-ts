...
### Adding Nuxt/typescript

Make sure you're not using `nuxt-ts` package as this is now deprecated

```sh
yarn add -D @nuxt/typescript nuxt-property-decorator
```

- `@nuxt/typescript` is TypeScript extension for `nuxt`
